...
%prep
%setup -q -n cheroot-8.4.5
cd %{_builddir}/cheroot-8.4.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598280971
...
cp %{_builddir}/cheroot-8.4.5/LICENSE.md %{buildroot}/usr/share/package-licenses/cheroot/feae831d4a94f4681630f513de63446524956d3d
