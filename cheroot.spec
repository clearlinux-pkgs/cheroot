...
Version  : 8.4.0
Release  : 38
URL      : https://files.pythonhosted.org/packages/09/43/12d4266b4aae91cc739bd1df3e937e8ec5963fa74063b99aa6227934b066/cheroot-8.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/09/43/12d4266b4aae91cc739bd1df3e937e8ec5963fa74063b99aa6227934b066/cheroot-8.4.0.tar.gz
...
%prep
%setup -q -n cheroot-8.4.0
cd %{_builddir}/cheroot-8.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595514416
...
cp %{_builddir}/cheroot-8.4.0/LICENSE.md %{buildroot}/usr/share/package-licenses/cheroot/feae831d4a94f4681630f513de63446524956d3d
