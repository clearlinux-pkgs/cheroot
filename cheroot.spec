...
Source0  : https://files.pythonhosted.org/packages/07/aa/62717ac01e8a4258a6731cbc6b85e477e6b46a512e5d074b296fa6f0b5dd/cheroot-8.5.1.tar.gz
...
%prep
%setup -q -n cheroot-8.5.1
cd %{_builddir}/cheroot-8.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607961406
...
cp %{_builddir}/cheroot-8.5.1/LICENSE.md %{buildroot}/usr/share/package-licenses/cheroot/feae831d4a94f4681630f513de63446524956d3d
